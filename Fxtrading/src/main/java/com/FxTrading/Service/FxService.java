...
import com.FxTrading.utility.CheckAvailability;
...
public class FxService {
	...
	public int addCcy(String ccy) {
		int status = 0;
		File file = new File("src/main/resources/ccy-info.properties");
	...
	public int exchangeCurrency(ForeignExchange currency) {
		int status = 0;

		File file = new File("src/main/resources/Exchange-details.properties");
		Properties properties = new Properties();
	...
	public Map<String, String> getAllExchanges() {
		...
		try (FileInputStream fileInputStream = new FileInputStream("src/main/resources/Exchange-details.properties")) {
